...
* TC_HashedLinkKey : Use a global TC Link key which is hashed by the eui64 of each node joining
* TC_UniqueLinkKey : Use a random unique TC link key for each node
