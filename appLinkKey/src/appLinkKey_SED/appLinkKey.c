 ...
 *  This file allows you to request an app link key to communicate with another
 *  device in the network specified by its eui64.
 *    - appLKey {eui64 of the remote node}
 *
 *  HOW TO USE :
 *   Include the header to the app.c
 *   In the emberAfMainInitCallback(), initialize the custom command group such as :
 *   sl_cli_command_add_command_group(sl_cli_handles[0], &my_request_cli_command_group);
 *   (follow app.c of this project).
 ******************************************************************************/
...
const sl_cli_command_entry_t my_request_cli_commands[] = {
...
/**
 * CLI Handler to request to the trust center an application link key with
 * another device
 * @param args
 */
